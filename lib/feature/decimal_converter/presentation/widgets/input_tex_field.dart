                  ...
                  builder: (context, value, child) {
                    return Tooltip(
                      ...
                      decoration: ShapeDecoration(
                        color:errorText==null? AppColors.checkCircleColor:AppColors.errorColor,
                      ...
                      message: errorText ?? "Looks good",
                      preferBelow: false,
                      child: IconButton(
                        icon:errorText==null?  Icon(
                          Icons.check_circle_outline,
                          color: controller.text.isEmpty?Colors.grey:AppColors.checkCircleColor,
                        ):const Icon(
                          Icons.error_outline,
                          color: AppColors.errorColor,
                        ),
